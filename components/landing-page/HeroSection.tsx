        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          ...
          >
            <div className="space-y-4">
              ...
              >
                Fivi Technologies streamlines your forex brokerage operations
                with our all-in-one platform. Manage clients, IBs, and trading
                all in one place.
              </p>
            </div>
            <div
          ...
          >
            <div className="relative w-full max-w-[500px] h-[400px] p-4">
              ...
              <div className="relative bg-black/20 backdrop-blur-sm p-6 rounded-2xl border border-white/10 shadow-2xl w-full h-full overflow-hidden">
                ...
                {/* Animated dots */}
                <div
                  className="absolute w-2 h-2 rounded-full bg-primary/80 animate-pulse-glow"
                  style={{ top: "25%", left: "30%", animationDelay: "0.1s" }}
                ></div>
                <div
                  className="absolute w-3 h-3 rounded-full bg-primary/60 animate-pulse-glow"
                  style={{ top: "40%", left: "70%", animationDelay: "0.7s" }}
                ></div>
                <div
                  className="absolute w-2 h-2 rounded-full bg-primary/80 animate-pulse-glow"
                  style={{ top: "65%", left: "40%", animationDelay: "1.3s" }}
                ></div>
              </div>
            </div>
          </div>
