 ...
 * Used by the phone field's country selector. GCC markets are listed first so
 * the most common defaults sit at the top; the rest follow alphabetically.
 */
export const dialCodes: DialCode[] = [
  ...
  { iso: "CG", name: "Congo - Brazzaville", dialCode: "+242", flag: "🇨🇬" },
  { iso: "CD", name: "Congo - Kinshasa", dialCode: "+243", flag: "🇨🇩" },
...
export const defaultDialCode: DialCode =
  dialCodes.find((c) => c.iso === "AE") ?? dialCodes[0];

export function dialCodeByIso(iso: string): DialCode | undefined {
  return dialCodes.find((c) => c.iso === iso.toUpperCase());
}
